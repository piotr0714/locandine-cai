...
\small
\textbf{APPUNTAMENTO:} 1 Gennaio 1901 Stazione di Bologna 2.30.00\\
\textbf{MEZZO DI TRASPORTO:} Pogo Stick
}}
...
\hline
\textbf{Descrizione:} & 
{\footnotesize Ascensione al monte dove Gesù tredicenne perse la sua bambola di paglia inciampando in un rovo di rosaspina. Per simulare le sue sofferenze di ritorno a Betlemme si procederà, come lui, saltellando, sui nostri pogo stick, disponibili in sezione per chi ne avesse bisogno} \\
\hline
\textbf{Dislivello Totale:} & 17m+ \\
\hline
\textbf{Distanza Totale:} & 30km \\
\hline
\textbf{Difficoltà:} & PS \\
\hline
\end{tabular}
...
\begin{tabular}{|p{3.5cm}|p{\dimexpr\textwidth-3.5cm-4\tabcolsep-3\arrayrulewidth\relax}|}
\hline
\rowcolor{celeste}\textbf{Accompagnatori:} & \cellcolor{arancione}{Giuseppe} \\ 
\hline
 & {{ACCOMPAGNATORIALTRI}} \\ 
\hline
\end{tabular}
...
\noindent
{\small
\textbf{PORTARE:} \href{https://www.cairoma.it/?page_id=22206}{\textbf{LISTA BASE}} + Pogo Stick e fede cristiana
...
Iscrizione fino a esaurimento posti: via \href{https://streamable.com/lf027o}{\textbf{form}} dall'20/02/2020 alle 20.20.00 al 10/10/1010 alle 10.10.00.
}
