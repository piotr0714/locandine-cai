  ...
  \node[anchor=south east, inner sep=0pt] at (\textwidth-0.3cm,-5.7cm) {
    \begin{tikzpicture}
      ...
      \node[anchor=center,rotate=-10] at (0,-0.15cm) {
        \begin{minipage}{3cm}
          \centering
          \small\textbf{Gole Celano}\\
          \footnotesize\textbf{{{DATACORTA}}}
        \end{minipage}
      };
    \end{tikzpicture}
  };
...
\small
\textbf{APPUNTAMENTO:} {{DATACOMPLETA}} Roma 5.05.00\\
...
\hline
\rowcolor{celeste}\multicolumn{2}{|l|}{\textbf{PROGRAMMA: Gole Celano}} \\
\hline
\textbf{Descrizione:} & 
{\footnotesize Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,Partenza da Celano,} \\
\hline
\textbf{Dislivello Totale:} & 500 \\
\hline
\textbf{Distanza Totale:} & 4 \\
\hline
\textbf{Difficoltà:} & EE \\
\hline
\end{tabular}
...
Iscrizione fino a esaurimento posti: via \href{}{\textbf{form}} dall'20/10/2025 alle 5.05.00 al 21/10/2025 alle 5.05.00.
}
