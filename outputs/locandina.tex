...
\small
\textbf{APPUNTAMENTO:} 14 Dicembre 2025 Piazza Sassari 7.00.00\\
...
\hline
\textbf{Descrizione:} & 
{\footnotesize nessuna } \\
\hline
\textbf{Dislivello Totale:} & 500 \\
\hline
\textbf{Distanza Totale:} & 16 km \\
\hline
\textbf{Difficoltà:} & E \\
\hline
\end{tabular}
...
\begin{tabular}{|p{3.5cm}|p{\dimexpr\textwidth-3.5cm-4\tabcolsep-3\arrayrulewidth\relax}|}
\hline
\rowcolor{celeste}\textbf{Accompagnatori:} & \cellcolor{arancione}{Luigi Cecili} \\ 
\hline
 & Riccardo; Arturo Valli ; ; ;   \\
\hline
\end{tabular}
}
