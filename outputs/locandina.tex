...
\hline
\rowcolor{celeste}\multicolumn{2}{|l|}{\textbf{PROGRAMMA: Monte Viglio}} \\
\hline
\textbf{Descrizione:} & 
{\footnotesize Descrizione Descrizio neDescrizioneDes crizioneDescrizioneDescrizioneDesc rizioneDescrizioneDescr izioneD escrizioneD escrizioneDescr izioneDescrizioneDescri zioneDes crizioneDescr izio neDescrizioneDescrizioneDescrizioneDescrizioneDescrizio neDescrizioneDescrizioneDescrizione  } \\
\hline
\textbf{Dislivello Totale:} &  \\
\hline
\textbf{Distanza Totale:} &  \\
\hline
\textbf{Difficoltà:} &  \\
\hline
\end{tabular}
...
\hline
 & Luigi; Gennaro; Aldo; Luigina; Luca  
\hline
\end{tabular}
}
...
Iscrizione fino a esaurimento posti: via \href{}{\textbf{form}} dall' alle  al  alle .
}
