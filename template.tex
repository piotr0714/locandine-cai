...
\small
\textbf{APPUNTAMENTO:} {{DATA_COMPLETA}} {{LUOGO}} {{ORA}}\\
\textbf{MEZZO DI TRASPORTO:} {{MEZZI}}
}}
...
\begin{tabular}{|p{3.5cm}|p{\dimexpr\textwidth-3.5cm-4\tabcolsep-3\arrayrulewidth\relax}|}
\hline
\rowcolor{celeste}\textbf{Accompagnatori:} & \cellcolor{arancione}{{ACC1}} \\ 
\hline
 & {{ACCOMPAGNATORI_OTHERS}} \\ 
\hline
\end{tabular}
}
...
\noindent
{\small
\textbf{PORTARE:} \href{https://www.cairoma.it/?page_id=22206}{\textbf{LISTA BASE}} + {{MATERIALE}}
...
Iscrizione fino a esaurimento posti: via \href{{{LINK_ISCRIZIONE}}}{\textbf{form}} dall'{{DATA_INIZIO}} alle {{ORA_INIZIO}} al {{DATA_FINE}} alle {{ORA_FINE}}.
}
