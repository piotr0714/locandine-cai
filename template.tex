...
\small
\textbf{APPUNTAMENTO:} {{DATACOMPLETA}} {{LUOGO}} {{ORA}}\\
...
Iscrizione fino a esaurimento posti: via \href{{{LINKISCRIZIONE}}}{\textbf{form}} dall'{{DATAINIZIO}} alle {{ORAINIZIO}} al {{DATAFINE}} alle {{ORAFINE}}.
}
