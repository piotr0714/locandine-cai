  ...
  \node[anchor=south east, inner sep=0pt] at (\textwidth-0.3cm,-5.7cm) {
    \begin{tikzpicture}
      ...
      \node[anchor=center,rotate=-10] at (0,-0.15cm) {
        \begin{minipage}{3cm}
          \centering
          \small\textbf{Gole di lullo}\\
          \footnotesize\textbf{22/10}
        \end{minipage}
      };
    \end{tikzpicture}
  };
...
\small
\textbf{APPUNTAMENTO:} 22 Ottobre 2025 Roma 4.44.00\\
...
\hline
\rowcolor{celeste}\multicolumn{2}{|l|}{\textbf{PROGRAMMA: Gole di lullo}} \\
\hline
\textbf{Descrizione:} & 
{\footnotesize } \\
\hline
\textbf{Dislivello Totale:} & 666 \\
\hline
...
\begin{tabular}{|p{3.5cm}|p{\dimexpr\textwidth-3.5cm-4\tabcolsep-3\arrayrulewidth\relax}|}
\hline
\rowcolor{celeste}\textbf{Accompagnatori:} & \cellcolor{arancione}{} \\ 
\hline
 & {{ACCOMPAGNATORIALTRI}} \\ 
\hline
\end{tabular}
